...
create your own very easy.  See the `crate/containers` directory for samples.
...
# Templates
Crate templates are cloud-init provisioned base containers that provide pre-packages functionality such as Redis, Nginx, etc.
